...
export function ContactHero() {
  return (
    <Section className="relative isolate overflow-hidden py-12 sm:py-16 lg:py-20" variant="soft">
      ...
      <Container>
        <div className="grid gap-10 lg:grid-cols-[minmax(0,0.95fr)_minmax(27rem,1.05fr)] lg:items-center">
          <div>
            ...
            <h1 className="mt-5 max-w-3xl text-4xl font-semibold leading-tight text-primary-dark sm:text-5xl lg:text-[3.25rem]">
          ...
          <div className="relative mx-auto h-[22rem] w-full max-w-[35rem] overflow-hidden rounded-[2rem] border border-border-soft bg-white/85 shadow-card">
