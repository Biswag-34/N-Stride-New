...
const programs = [
  {
    ...
    features: [
      "Advanced foot scanning setup",
      "VIBRASENSE+T for neuropathy and temperature screening",
      "VASOSENSE AUTO ABI for vascular-flow assessment",
      "PODOGRAPH_P for 2D pressure-point mapping",
      "2 days intensive team training",
      "₹1 lakh footwear and socks inventory at 50% discount on MRP",
    ],
  },
  {
    ...
    featured: true,
    features: [
      "All Essential diagnostic modules",
      "4 days intensive team training",
      "₹2 lakh footwear and socks inventory at 50% discount on MRP",
      "Hand-held Doppler support as required",
      "₹1 lakh NPWT machines and kits",
      "Display models and branded clinic rack",
    ],
  },
];
