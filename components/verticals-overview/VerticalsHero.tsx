...
const heroMetrics = [
  { label: "Assessment-led guidance", icon: overviewIconMap.protect },
  { label: "Four connected verticals", icon: overviewIconMap.partner },
  { label: "Technology-enabled pathways", icon: overviewIconMap.analysis },
  { label: "Coordinated follow-up", icon: overviewIconMap.outcome },
];
    ...
    <section className="relative isolate overflow-hidden bg-[linear-gradient(180deg,#f4fbff,#ffffff)] px-4 pb-6 pt-5 md:hidden">
      ...
      <div className="relative z-10">
        ...
        <h1 className="mt-3 font-heading text-[1.82rem] font-extrabold leading-[1.08] text-primary-dark">
          Four specialised pathways. One connected care ecosystem.
        </h1>
        <p className="mt-2 text-[0.86rem] font-medium leading-6 text-text-secondary">
          Explore therapeutic footwear, foot assessment, wound-care support, prosthetics, orthotics and silicone restoration—with a clear route to the right service.
        </p>
