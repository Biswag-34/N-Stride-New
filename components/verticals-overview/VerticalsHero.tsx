...
function HeroEcosystemVisual() {
  return (
    <div
      ...
      className="relative mx-auto aspect-[488/374] w-full max-w-[38.5rem] overflow-visible drop-shadow-[0_24px_48px_rgba(20,121,201,0.08)]"
    >
      <Image
...
export function VerticalsHero() {
  ...
  return (
    <section className="relative isolate overflow-hidden bg-[radial-gradient(circle_at_75%_30%,rgba(38,182,200,0.12),transparent_31rem),linear-gradient(180deg,#ffffff_0%,#f4faff_100%)] pb-12 pt-11 sm:pt-14 lg:pb-14">
      <Container>
        <div className="grid items-center gap-10 lg:grid-cols-[0.86fr_1.14fr]">
          <motion.div initial={reduceMotion ? false : "hidden"} animate={reduceMotion ? undefined : "visible"} variants={staggerContainer}>
            ...
            <motion.h1 className="mt-5 max-w-[32rem] text-[2.75rem] font-semibold leading-[1.05] text-primary-dark sm:text-5xl lg:text-[3.55rem]" variants={fadeUp}>
              One Ecosystem.
              <br />
              Four Verticals.
              <br />
            ...
            <motion.div className="mt-7 flex flex-col gap-3 sm:flex-row" variants={fadeUp}>
              ...
              <Button className="rounded-[0.45rem] px-6" href={ctas.stepAhead.href} variant="outline">
